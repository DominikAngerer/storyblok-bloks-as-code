...
/**
 * Feature Card — a nestable card component for feature grids.
 *
 * Demonstrates: number field with min/max/steps, textarea, multilink,
 * option with datasource (internal), asset, conditional visibility,
