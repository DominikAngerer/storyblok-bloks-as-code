import { defineComponent, text, textarea, asset, bloks, option, tab } from "../src/index.js";

/**
 * Page — a root content type for pages.
 *
 * Demonstrates: content type (is_root), tabs, text, textarea, asset,
 * single-option with self-defined options, and a bloks field with
